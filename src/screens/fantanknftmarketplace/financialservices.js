            ...
            <ScrollView>
                ...
                <View style={{ marginTop: 50, paddingHorizontal: 15 }} >
                    ...
                    <View style={{ marginTop: 40 }} >
                        {data.map((d, i) => (
                            <View key={i} style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: "#252525", width: '100%', alignSelf: "center", paddingVertical: 15, paddingHorizontal: 10, borderRadius: 10, marginVertical: 5 }} >
                                <View style={{ width: "90%" }} >
