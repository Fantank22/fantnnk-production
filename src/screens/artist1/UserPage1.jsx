    ...
    return (
        <View style={styles.container} >
            <ScrollView
                ...
                <View style={styles.container}>
                    <ImageBackground
                        source={require("../../assets/artist/userpage1bg.png")}
                        ...
                        <View
                            ...
                            <View
                                ...
                                >
                                    Los Angeles, CA · <Image source={require('../../assets/artist/canadianflag.png')} />
                                </Text>
                                <View
                                    style={{
                                        display: "flex",
                                ...
                                >
                                    ...
                                    <View>
                                        <Image
                                            source={require("../../assets/artist/userBadge1.png")}
                    ...
                    <View style={{ paddingHorizontal: 10 }} >
                        ...
                        <View style={{ backgroundColor: "#4B4B4C", padding: 10, borderRadius: 5, marginTop: 15 }} >
                            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }} >
                                <Image style={{ width: 60, height: 60, borderRadius: 30 }} source={require('../../assets/artist/randyben.png')} />
                                <View>
                                    <View
                                        style={{
                                            display: "flex",
