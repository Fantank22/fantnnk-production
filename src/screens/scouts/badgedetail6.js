...
export const BadgeDetail6 = ({ navigation }) => {
  const content = [
    {
      title: "# of friends",
      logo: "image",
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
          ...
          <View style={styles.cardContainer}  >
            <View style={styles.cardContainerHeader}  >
              <View style={styles.rowItem}  >
                ...
                />
                <View>
                  <Text style={{ color: "white", fontSize: 16 }}>  Badge 6  </Text>
        ...
        >
          ...
          {/* <View style={{ alignSelf: "center", paddingVertical: 25 }} >
            <Image
              ...
              source={require("../../common/assets/images/scouts/badge4Team.png")}
            />
          </View> */}
          <View
        ...
        >
          ...
          <TouchableOpacity onPress={() => navigation.navigate('BadgeDetail7')}>
            <View
              style={{
                flexDirection: "row",
                alignItems: "center",
