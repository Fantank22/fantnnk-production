...
export const BadgeDetail10 = ({ navigation }) => {
  const content = [
    {
      title: "# of friends",
      logo: "image",
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView>
          ...
          <View style={styles.cardContainer}  >
            <View style={styles.cardContainerHeader}  >
              <View style={styles.rowItem}  >
                ...
                />
                <View>
                  <Text style={{ color: "white", fontSize: 16 }}> Badge 10</Text>
        ...
        >
          ...
          <TouchableOpacity onPress={() => navigation.navigate('BadgeDetail10')}>
            <View
              style={{
                flexDirection: "row",
                alignItems: "center",
